...
% function parameter
b0 = parser(param, 'b0', max(n1, n2));
bStep = parser(param, 'bStep', 1.075);
bMax = parser(param, 'bMax', 200);
tolB = parser(param, 'tolB', 1e-3);
tolC = parser(param, 'tolC', 1e-3);
maxBIters = 1000;
nthIter = 200;
